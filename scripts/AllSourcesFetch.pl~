...
#add(append("http://www.standaard.be",fetch("http://www.standaard.be/rssfeeds","<a class=\"info\" target=\"_blank\" href=\"(/rss/.*?)\">.*?</a>")));
#add(uniq(fetch("http://www.nieuwsblad.be/article/detail.aspx?articleid=DMA13102005_004","href=\"(http://feeds.*?)\">")));
